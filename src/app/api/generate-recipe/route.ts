...
export async function POST(req: NextRequest) {
  ...
  const disliked_food = Array.isArray(profile.disliked_food) ? profile.disliked_food.join(", ") : profile.disliked_food || "None";
  const cuisine_preference = Array.isArray(profile.cuisine_preference) ? profile.cuisine_preference.join(", ") : profile.cuisine_preference || "None";
